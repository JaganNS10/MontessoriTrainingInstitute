(function (global, factory) {
  ...
  function addEvent(eventName) {
    ...
    handler.destroy = function () {
      each(element, function (el) {
        var   = getNode (el, eventName, handler);
        if ( .found) {
           .all.splice( .evt, 1);
        }
    ...
    each(element, function (el) {
      var   = getNode (el, eventName, handler);
      if (el.addEventListener && avoidDuplicate && ! .found || !avoidDuplicate) {
  ...
  function keyboardNavigation(instance) {
    if (instance. .hasOwnProperty('keyboard')) {
      return false;
    }
    instance. ['keyboard'] = addEvent('keydown', {
      onElement: window,
      withCallback: function withCallback(event, target) {
  ...
  function slideInline(slide, data, index, callback) {
    ...
    this. ['inlineclose' + hash] = addEvent('click', {
  ...
  var Slide = function () {
    ...
    return _createClass(Slide, [{
        ...
        if (slideConfig.title == '' && slideConfig.description == '') {
          ...
          if (slideText && slideConfig.description !== '') {
            ...
            if (isMobileDevice && settings.moreLength > 0) {
              ...
              this.description (slideText, slideConfig);
            } else {
      ...
      key: "description ",
      value: function description (desc, data) {
        var _this2 = this;
  ...
  var  HandlerAdmin = function () {
    ...
    return _createClass( HandlerAdmin, [{
      key: "add",
  ...
  function touchNavigation(instance) {
    if (instance. .hasOwnProperty('touch')) {
      return false;
    }
    ...
    var touchInstance = new Touch (sliderWrapper, {
    ...
    return _createClass(GlightboxInit, [{
      ...
      value: function insertSlide() {
        ...
        if (this.slidesContainer) {
          if (index > totalSlides) {
            this.slidesContainer.appendChild( lide);
          } else {
            var existingSlide = this.slidesContainer.querySelectorAll('.gslide')[index];
            this.slidesContainer.insertBefore( lide, existingSlide);
          }
      ...
      value: function close() {
        ...
        animateElement(this.activeSlide, this.settings.cssEfects[this.settings.closeEffect].out, function () {
          ...
          _this8.built = false;
          if (_this8. ) {
            for (var _key in _this8. ) {
              if (_this8. .hasOwnProperty(_key)) {
                _this8. [_key].destroy();
              }
            }
            _this8.  = null;
      ...
      value: function trigger(eventName) {
        ...
        var onceTriggered = [];
        each(this.api , function (event, i) {
          var evt = event.evt,
            once = event.once,
      ...
      value: function clearAll () {
        this.api .splice(0, this.api .length);
      }
    }, {
      key: "version",
