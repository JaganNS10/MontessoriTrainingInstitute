...
function getContextualTokenSeparator(match, scope, flags) {
  ...
  // This also ensures all tokens remain as discrete atoms, e.g. it pr  converting the
  // syntax error `(? :` into `(?:`.
 ...
 *     flag, which pr  XRegExp from throwing an 'unknown flag' error when the flag is used.
